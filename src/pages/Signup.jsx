...
import { Activity, UserPlus, Info, Check, ArrowLeft, Phone, Building, User, Mail, Lock } from 'lucide-react'
  ...
  if (showCheckEmail) {
    return (
      <div className="gradient-bg min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md glass-panel p-8 rounded-3xl shadow-xl space-y-6 text-center relative overflow-hidden animate-fade-in">
          ...
          <p className="text-sm text-slate-500 leading-relaxed">
            ...
            Por favor, revisa tu bandeja de entrada y spam para activar tu cuenta de cliente.
          </p>
          <div className="pt-4">
            <Link
              to="/login"
    ...
    <div className="gradient-bg min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl shadow-xl space-y-6 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center space-y-2 relative">
          <div className="h-12 w-12 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-indigo-600/30">
            <Activity className="h-6 w-6 animate-pulse" />
          </div>
          <h2 className="text-2xl font-black tracking-tight text-slate-800 dark:text-white pt-2">Registro de Clínica Nueva</h2>
          <p className="text-sm text-slate-500 max-w-xs leading-normal">
            Cree su cuenta de cliente para gestionar sus equipos y solicitar citas de servicio.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 relative">
          <div>
            ...
            <input
              ...
              placeholder="Ej: Clínica Santa María, Dental Care..."
          ...
          <div className="border-t border-slate-100 dark:border-slate-800/80 my-4 pt-3">
